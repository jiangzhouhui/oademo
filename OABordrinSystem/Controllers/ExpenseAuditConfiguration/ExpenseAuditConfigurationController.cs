...
namespace OABordrinSystem.Controllers.ExpenseAuditConfiguration
{
    public class ExpenseAuditConfigurationController : BaseController
    {
        // GET: ExpenseAuditConfiguration
        public ActionResult Index()
        {
            ViewBag.CurrentName = Common.GetLanguageValueByParam("审核人配置表", "CommonName", "Common", ViewBag.language);
            return View();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public JsonResult SaveExpenseAuditConfiguration(ExpenseAuditConfigurationModel model)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public JsonResult DeleteExpenseAuditConfiguration(string id)
        {
            var retModel = new JsonReturnModel();
            try
            {
